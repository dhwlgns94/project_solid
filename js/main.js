 ...
 */    navigation: {
  ...
  $(".section_7_txt ul li").mouseenter(function(){
    $(this).addClass("on").siblings().removeClass("on");
    $(this).find("a").addClass("on");
    $(this).siblings().find("a").removeClass("on");
    var Num = $(this).index();
    $(".section_7_img img").eq(Num).stop().fadeIn().siblings().stop().fadeOut();
  });


  $(".section_7_txt ul li:nth-child(1)").addClass("on");
  $(".section_7_txt ul li:nth-child(1) a").addClass("on");

  $(".section_7_imgbox img").eq(1).hide();
...
$("#section_8 iframe").hide();

$(".section_8_txt p:last-child").mousedown(function(){
  $(this).css({"opacity" : "0.5"});
});

$(".section_8_txt p:last-child").mouseup(function(){
  $(this).css({"opacity" : "1"});
});

$(".section_8_txt p:last-child").click(function(){

  $("#section_8 iframe").stop().slideToggle();
